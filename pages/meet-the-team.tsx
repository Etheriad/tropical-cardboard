...
const PROFILES = [
  {
    ...
    worht it because it would cost about the same in electricity as\
    I would make mining and it was complicated for someone who didnt\
    know much about computers and programming. Bitcoin was around\
    $100 usd. In 2017 I rediscovered cryptocurencies after hearing\
    about a project network that used the same technology as\
    bitcoin, but instead of just tranferring ballences, you could\
    create computer programs. It was called Ethereum. I thought that\
    sounded like an impcatful project and learned how to buy some\
    when it was around $300 usd. THe price jumped a few months later\
    and I happily sold what I had to pay for some travel. The\
    ...
    network. I bought back in after having sold all my Ether in 2017\
    and went to opensea to check it out. I didnt see much that\
    ...
    of 2021, I hear about some NFTs that were selling at Christies\
    ...
    different projects and their communities in discord. Some of my\
